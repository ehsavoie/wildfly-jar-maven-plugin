...
You only need to configure the The only required changes is about configuring how to connect to the remote application using the management API.

So you have to to configure your bootable jar to allow remote connection to the mangament interface.
...
So once you have your application running you can execute the goal locally or by configuring a profile like this:
[source,bash]
----
